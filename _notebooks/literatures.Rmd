...
Integration
    ...
    - 02
        ...
        - 10
            ...
            37. [Vialet-Chabrand et al. 2017; Plant Physiol](http://www.plantphysiol.org/content/early/2017/02/09/pp.16.01767.short?rss=1); 高
                ...
                - ようやくダウンロード (20170509)
                    - これはいい論文のにおいがする
                    - 変動x強光は定常x強光と比較して陰葉よりの資源利用 (厚さ・呼吸速度など) だが、PPFD-Pn~area~は同レベルで、PPFD-Pn~mass~だと有利
                        - タンパク系はあまり差なし
        ...
        - 12
            ...
            38. [Mishanin et al. 2017; Photosynth Res](http://link.springer.com/article/10.1007/s11120-017-0339-1); 20170219済
                ...
                - *F*~685~/*F*~740~比に注力
                    ...
                    - chloroplast movement: *t*~1/2~ ~ 10 min (Ptushenko et al. 2017)
                - LLだと77K蛍光ピーク強度比のstate transitionが単相だが、HLだと二相？
                - *T*~light~/*T*~dark~の絶対値の議論には意味がない
                    - *T*~dark~が小さい場合に安定しないので
        ...
        - 13
            ...
            40. [Mishanin et al. 2016; Photosynth Res](http://link.springer.com/article/10.1007%2Fs11120-016-0252-z); 中
                - Light acclimation of shade-tolerant and light-resistant *Tradescantia* species: induction of chlorophyll *a* fluorescence and P~700~ photooxidation, expression of PsbS and Lhcb1 proteins
                - `Mishanin et al. 2017`から
        ...
        - 22
            ...
            48. [Vavasseur & Raghavendra 2005; New Phytol](http://onlinelibrary.wiley.com/wol1/doi/10.1111/j.1469-8137.2004.01276.x/full); <FONT color="green">低</FONT>
                - Guard cell metabolism and CO~2~ sensing
    ...
    - 3
        ...
        - 03
            ...
            61. [Zhen & van Iersel, 2017; J Plant Physiol](http://www.sciencedirect.com/science/article/pii/S0176161716302826); 20170303済
                ...
                - FR添加に対して、PSIIの光化学反応は速やかに応答してEmerson様の*Y*~II~上昇が生じるが、NPQ形成には時間遅れがある
        ...
        - 14
            ...
            80. [Li et al. 2017; Int J Hydrogen Energy](http://www.sciencedirect.com/science/article/pii/S0360319917302756); 高・未刊
                - Light conversion film promotes CO~2~ assimilation by increasing cyclic electron flow around Photosystem I in *Arabidopsis thaliana*
                - 初見の雑誌 & グループ
        ...
        - 24
            ...
            91. [Silva-Pérez et al. 2017; PCE](http://onlinelibrary.wiley.com/wol1/doi/10.1111/pce.12953/abstract); 低・未刊
                - Biochemical model of C~3~ photosynthesis applied to wheat at different temperatures
                - Evansグループ
        ...
        - 26
            ...
            92. [Tcherkez et al. 2017; New Phytol](http://onlinelibrary.wiley.com/wol1/doi/10.1111/nph.14527/full); <FONT color="green">20170326済・引</FONT>
                ...
                - 分解能も効いてるのかな
                    - “A recommendation to solve this problem is to have a sufficient number of measurements: typically, at least three in the 0--10 lmol m^-2^ s^-1^ region.”
            ...
            93. [Yin et al. 2014; Photosynth Res](https://link.springer.com/article/10.1007%2Fs11120-014-0030-8); 20170417済
                ...
                - Y~II~を測定することで、ガス交換の最大量子収率を上方修正する手法について
                    - 利用側ではなく、理解側の観点がつよい
    ...
    - 4
        ...
        - 06
            ...
            99. [Ibaraki & Matsuura 2005; J Agric Meteorol](https://www.jstage.jst.go.jp/article/agrmet/60/5/60_1073/_article/-char/ja/); 20170407済
                ...
                - *F*~v~/*F*~m~イメージング
                - *F*~v~/*F*~m~既知のreference葉を並べて測定することで、距離係数のkを算出
        ...
        - 16
            ...
            111. [Yin et al. 2009; PCE](http://onlinelibrary.wiley.com/wol1/doi/10.1111/j.1365-3040.2009.01934.x/full); 高
                - Using combined measurements of gas exchange and chlorophyll fluorescence to estimate parameters of a biochemical C~3~ photosynthesis model: a critical appraisal and a new integrated approach applied to leaves in a wheat (*Triticum aestivum*) canopy
                - `Yin et al. 2014`から
                    - “To estimate Φ~2LL~, we used the equation that describes the decline of Φ~2~ with increasing irradiance (Yin et al. 2009).”
        ...
        - 19
            ...
            124. [Peñuelas et al. 2011; New Phytol](http://onlinelibrary.wiley.com/wol1/doi/10.1111/j.1469-8137.2011.03791.x/full); <FONT color="green">20170419済・引</FONT>
                - Photochemical reflectance index (PRI) and remote sensing of plant CO~2~ uptake
        ...
        - 20
            ...
            132. [Peñuelas et al. 1995; New Phytol](http://onlinelibrary.wiley.com/wol1/doi/10.1111/j.1469-8137.1995.tb03064.x/abstract); 20170420済
                ...
                - 光強度変化への応答は、PRIではY~ii~より遅い
                - “some species exhibited additional complicating features that could have influenced *R*~531~, including significant chloro- plast movement in *Phaseolus vulgaris* and a small xanthophyll content in the shade-adapted leaves of *Hedera canariensis* (unpublished).”
        ...
        - 21
            ...
            136. [Weng et al. 2010; Tree Physiol](https://academic.oup.com/treephys/article/30/4/469/1682565/Relationship-between-photochemical-efficiency-of); 高
                ...
                - PRIとY~ii~の相関を、光条件、季節、葉色の異なる複数条件からマージ
        
        - 22
        
            137. [Earles et al. 2017; Plant Physiol](http://www.plantphysiol.org/content/early/2017/04/21/pp.17.00223.short?rss=1); 高・未刊
                - Excess diffuse light absorption in upper mesophyll limits CO~2~ drawdown and depresses photosynthesis
                - 散乱光は、個葉レベルではCO~2~固定にネガティブ
    ...
    - 5
        ...
        - 9
            ...
            160. [Thomas et al. 2017; Funct Plant Biol](http://www.publish.csiro.au/FP/FP16127); 中・未取得
            ...
            162. [Méthy 2000; Photosynthica](https://link.springer.com/article/10.1023/A:1012449104831); 20170509済
                ...
                - Fig.3Bが問題の図
                    - 渦相関で出したCO~2~ FluxとPRIの時系列
                    - {CO~2~ Flux / PPFD} vs PRIで書いていないから議論にならない
