...
journal_articles <-
  c(
    ...
    ToRecord(
      new_item("Quantification of excitation energy distribution between photosystems based on a mechanistic model of photosynthetic electron transport"),
    ...
    ToRecord(
      ...
      "",
      ""),
      # paste0("Planta", impacts[7]),
      # "http://onlinelibrary.wiley.com/wol1/doi/10.1111/pce.12986/abstract")

    ToRecord(
      coming_item("Short-term response of photochemical reflectance index (PRI) during photosynthetic induction: time delay and correlation against photochemical yield of photosystem II."),
...
symp_domestic <-
  c(
    ToRecord(
      new_item("分光画像計測による光合成速度分布解析の試み"),
      paste(speaker(KM_), YI_, sep = ", "),
      "2018",
      "Oral",
      "日本農業気象学会 2018 年全国大会<br>鳥取, 2018/03/13-2018/03/17",
      ""),
    ...
    ToRecord(
      ...
      "2017",
      "Oral",
      "日本農業気象学会 中国四国支部大会<br>鳥取, 2017/12/07-2017/12/08",
      ""),
    ...
    ToRecord(
      ...
      "2017",
      "Oral",
      "日本生物環境工学会 2017 年松山大会<br>愛媛, 2017/08/30-2017/09/04",
      ""),
    ...
    ToRecord(
      ...
      "2017",
      "Poster",
      "第 8 回日本光合成学会年会<br>滋賀, 2017/05/27-2017/05/28",
      ""),
    ...
    ToRecord(
      ...
      "2016",
      "Oral",
      "日本農業気象学会 2016 年全国大会<br>岡山, 2016/03/14-2016/03/17",
      ""),
    ...
    ToRecord(
      ...
      "2015",
      "Oral",
      "日本生物環境工学会 2015 年宮崎大会<br>宮崎, 2015/09/08-2015/09/11",
      ""),
    ...
    ToRecord(
      ...
      "2015",
      "Oral",
      "日本農業気象学会 2015 年全国大会<br>つくば, 2015/03/16-2015/03/19",
      ""),
    ...
    ToRecord(
      ...
      "2014",
      "Poster",
      "第 5 回日本光合成学会年会<br>奈良, 2014/05/30-2014/05/31",
      ""),
    ...
    ToRecord(
      ...
      "2014",
      "Oral",
      "日本農業気象学会 2014 年全国大会<br>札幌, 2014/03/18-2014/03/21",
      ""),
    ...
    ToRecord(
      ...
      "2013",
      "Oral",
      "日本生物環境工学会 2013 年香川大会<br>高松, 2013/09/02-2013/09/05",
      ""),
    ...
    ToRecord(
      ...
      "2012",
      "Oral",
      "日本生物環境工学会 2012 年東京大会<br>東京, 2012/09/04-2012/09/07",
      ""),
    ...
    ToRecord(
      ...
      "2012",
      "Poster",
      "日本農業気象学会 2012 年全国大会<br>大阪, 2012/03/13-2012/03/17",
      "")
  )
```
