...
AddCrsp <- function(text) paste0(text, "*")
AddEqual <- function(text) paste0(text, "<sup>+</sup>")
# Frequently appears
...
c(
  ...
  ToRecord(
    "Quantification of excitation energy distribution between photosystems based on a mechanistic model of the photosynthetic electron transport",
    paste(AddCrsp(KM), "and others (to be determined)", sep = ", "),
    "in prep.",
    "Original Article",
    "-",
    "")
